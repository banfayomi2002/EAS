...
#property description "Pick trade during high impact news."
#property description "The EA Created By SheriffOnline.com and Modified for full automation by Austine fayomi"
#property strict
//---
#include <stdlib.mqh>
...
//---
  ...
  //////////////////////////////////////////////////////////////////////
    ...
    void GetAllEventsExceptHistory()
  {
   ...
   for(i=obj_total-1;i>=0;i--)
     {
         ...
         if (ObjectType(name)==OBJ_EVENT )
         {
           ...
           if (time == TimeCurrent()) NewsTime = true;  
...
void PrintInfoToChart()
  {
   string temp="News Hour Trade updated for fully automation by Austine Fayomi\n"
               ...
               +"Contact Author: austine.fayomi@gmail.com\n"
               +"------------------------------------------------\n";
   Comment(temp);
   Count15++;
  }
